...
export interface Industry {
  ...
  painPoints: string[];
  description: string;
  recommendedTier: 'solo' | 'pro' | 'enterprise';
...
export const industries: Industry[] = [
  {
    ...
    heroTitle: 'Stop Fighting Fires. Start Running Your Cafe.',
    painPoints: [
    ...
    description: 'A locally-hosted automation platform that transforms your cafe into an intelligently-managed operation. Runs on a Mac Mini in your back office.',
    recommendedTier: 'solo',
    recommendedTierName: 'Nous Solo',
    startsFrom: '$2,800',
    features: [
      ...
      { name: 'Shift Swap Arbiter', description: 'Staff texts "can\'t work Friday" and the system finds coverage automatically', monthlyValue: 'Manager time saved' },
      ...
      { name: 'Slow Day Activator', description: 'Tuesday dead? One-tap flash sale to your customer list', monthlyValue: 'Dead hours to revenue' },
    ...
    caseStudy: {
      ...
      author: "Maria",
      role: "Cafe Owner, Brooklyn",
      result: "$800 saved in first week",
    },
  },
  {
    id: 'salon',
    name: 'Nous for Salons',
    slug: 'salon',
  ...
  },
  {
    ...
    features: [
      ...
      { name: 'Invoice Generation', description: 'Auto-create and send invoices for vertical markets', monthlyValue: 'Faster billing' },
      { name: 'Client Dashboards', description: 'Pre-built views for each client before meetings', monthlyValue: '2 hrs prep to 5 min' },
  ...
  },
  {
    ...
    description: 'Restaurant-specific AI combining cafe operations with full-service requirements: reservation management, kitchen display integration, menu engineering, and multi-location oversight.',
    recommendedTier: 'pro',
    recommendedTierName: 'Nous Pro',
    startsFrom: '$4,800',
    features: [
  ...
  },
  {
    ...
    recommendedTierName: 'Nous Enterprise',
    startsFrom: '$7,500',
    features: [

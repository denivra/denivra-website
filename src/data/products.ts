...
export const products: Product[] = [
  {
    ...
    price: 'from $2,800',
    priceLabel: 'one-time',
    description: 'Text it on Telegram. It reads your emails, summarizes them, proposes actions, files receipts, manages your calendar, and syncs with HubSpot — all running locally on a Mac Mini in your office. Like having an assistant you can message anytime.',
    ...
    features: [
      'Message it via Telegram — it does the work',
      'Email summaries with proposed actions',
      'Smart auto-responses to routine emails',
      'WhatsApp / Telegram customer bot',
      'Document & receipt extraction to accounting',
      'HubSpot CRM light sync (contacts & deals)',
      'Calendar management & smart scheduling',
      'Review monitoring & draft responses',
      'Daily activity dashboard & morning briefing',
      'Local file access & auto-organization',
      'Research tasks on demand via chat',
      '10 pre-built n8n workflows included',
      'Mac Mini hardware included',
    ],
    capabilities: [
      { name: 'Message It Anytime', description: 'Text your Nous on Telegram — ask it to research, send emails, check files, or schedule meetings. It works while you move.' },
      { name: 'Email Intelligence', description: 'Reads every email, summarizes the important ones, and proposes actions. You approve with one tap.' },
      { name: 'Messaging Bot', description: 'WhatsApp & Telegram bot for customer inquiries, lead capture, and automated responses in under 30 seconds' },
      { name: 'Document Processing', description: 'Extract data from receipts, invoices, PDFs — auto-push to your accounting system or CRM' },
      { name: 'HubSpot Sync', description: 'Light CRM integration — new contacts auto-created, deals updated, activities logged from emails and messages' },
      { name: 'Smart Calendar', description: 'Auto-schedule appointments, send reminders, prevent conflicts, and brief you before each meeting' },
      { name: 'Review Guardian', description: 'Monitor Google/Yelp reviews and draft responses for your approval' },
      { name: 'Activity Dashboard', description: 'Morning briefing of everything your AI did overnight — delivered via Telegram, email, or dashboard' },
    ],
    integrations: ['Gmail', 'Google Calendar', 'WhatsApp Business', 'Telegram', 'HubSpot (Light)', 'Airtable', 'Notion', 'Google Drive', 'Instagram'],
    workflowCount: '10',
    highlighted: false,
    tier: 'solo',
  },
